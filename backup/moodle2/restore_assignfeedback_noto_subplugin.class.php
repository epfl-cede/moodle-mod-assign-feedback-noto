...
class restore_assignfeedback_noto_subplugin extends restore_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/feedback_noto');
    ...
    /**
     * Processes one feedback_noto element
     * @param mixed $data
     */
    public function process_assignfeedback_noto_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignfeedback_noto', $data);

        $this->add_related_files('assignfeedback_noto', 'feedback_noto', 'grade', null, $oldgradeid);
    }
